...
const Basic = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        else setSuccess("Account created! Please check your email to confirm your registration.");
    };
                                ...
                                <div className="row gy-3">
                                    <Form onSubmit={handleSubmit} className="w-100">
                                        <div className="col-xl-12">
                                            ...
                                            <input type="email" className="form-control form-control-lg" id="signup-email" placeholder="email" value={email} onChange={e => setEmail(e.target.value)} required />
                                        </div>
                                        <div className="col-xl-12">
                                            <label htmlFor="signup-password" className="form-label text-default">Password</label>
                                            <InputGroup>
                                                <Form.Control type={passwordshow1 ? 'text' : 'password'} className="form-control-lg" id="signup-password" placeholder="password" value={password} onChange={e => setPassword(e.target.value)} required />
                                        ...
                                        <div className="col-xl-12 mb-2">
                                            ...
                                            <InputGroup>
                                                <Form.Control type={passwordshow2 ? 'text' : 'password'} className="form-control-lg" id="signup-confirmpassword" placeholder="confirm password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} required />
                                        ...
                                        <div className="col-xl-12 d-grid mt-2">
                                            <Button type="submit" className="btn btn-lg btn-primary" disabled={loading}>{loading ? 'Creating...' : 'Create Account'}</Button>
                                        </div>
                                    </Form>
                                </div>

...
function Layout({ children, local_varaiable, ThemeChanger }: any) {
  const customstyles: any = {
    ...
    ...(local_varaiable.darkBg !== "" && {
      "--body-bg-rgb2": local_varaiable.darkBg,
    }),
    ...(local_varaiable.inputBorder !== "" && {
      "--input-border": `rgba(${local_varaiable.inputBorder})`,
    }),
    ...(local_varaiable.formControlBg != "" && {
      "--form-control-bg": `rgb(${local_varaiable.bodyBg})`,
    }),
    ...(local_varaiable.Light !== "" && {
      "--light-rgb": local_varaiable.bodyBg,
    }),
  };
    ...
    <>
      ...
      >
        <head>
          ...
          <meta
            name="keywords"
            content="nextjs template,nextjs admin template,admin,nextjs dashboard template,app router,router admin,admin panel template,dashboard,admin template,firebase nextjs,typescript,next js typescript,react bootstrap component,admin dashboard template,reactbootstrap"
          />
        </head>

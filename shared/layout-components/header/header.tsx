          ...
          <div className="header-content-right">
            ...
            >
              ...
              >
                ...
                <Badge
                  bg=" bg-primary rounded-pill header-icon-badge"
                  id="cart-icon-badge"
                >
                  {cartItemCount}
                </Badge>
                  ...
                  {notifications.map((notification, index) => (
                    ...
                    >
                      <div className="d-flex align-items-start">
                        <div className="pe-2">
                          <span
                            className={`avatar avatar-md bg-${notification.color1} avatar-rounded`}
                          >
            ...
            <Dropdown className="header-element header-shortcuts-dropdown">
              ...
              <Dropdown.Menu
                className="main-header-dropdown header-shortcuts-dropdown pb-0 dropdown-menu-end"
            ...
            <Dropdown className="header-element profile-dropdown">
              ...
              >
                <Dropdown.Item as="li">
                  <Link className="d-flex" href="#!" scroll={false}>
                ...
                <Dropdown.Item as="li">
                  <Link className="d-flex" href="#!" scroll={false}>
                    ...
                    <span className="ms-auto badge bg-success-transparent">
                      25
                    </span>
                  </Link>
                </Dropdown.Item>
      ...
      >
        <Modal.Body>
          ...
          <div className="mt-4">
            ...
            {allData.map((idx) => (
              <span key={Math.random()} className="search-tags">
